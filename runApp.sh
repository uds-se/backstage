...
$JDK/java -Xmx40g -Xss5m -cp target/Backstage-5.0-SNAPSHOT-jar-with-dependencies.jar st.cs.uni.saarland.de.testApps.TestApp -apk ${file} -androidJar $ANDROID_JAR -apkToolOutput output/$appName -rAnalysis -uiTimeoutValue 30 -uiTimeoutUnit SECONDS -rTimeoutValue 30 -rTimeoutUnit SECONDS -rMaxDepthMethodLevel 15 -numThreads 24 -rLimitByPackageName
